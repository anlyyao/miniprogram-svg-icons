...
京东小程序 SVG 多色图标组件库，支持多品牌图标源（如 TDesign）。
...
```bash
npm install @mp-svg-icons/jd
# 或
pnpm add @mp-svg-icons/jd
```
...
{
  "usingComponents": {
    "add-icon": "@mp-svg-icons/jd/tdesign/add-icon",
    "close-icon": "@mp-svg-icons/jd/tdesign/close-icon"
  }
}
```
...
npx mp-svg-icons-clear \
  --pkg-dir ./node_modules/@mp-svg-icons/jd/tdesign \
