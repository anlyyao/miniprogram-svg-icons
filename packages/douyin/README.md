...
抖音小程序 SVG 多色图标组件库，支持多品牌图标源（如 TDesign）。
...
```bash
npm install @mp-svg-icons/douyin
# 或
pnpm add @mp-svg-icons/douyin
```
...
{
  "usingComponents": {
    "add-icon": "@mp-svg-icons/douyin/tdesign/add-icon",
    "close-icon": "@mp-svg-icons/douyin/tdesign/close-icon"
  }
}
```
...
{
  "usingComponents": {
    "t-icon": "@mp-svg-icons/douyin/icon"
  }
}
```
...
npx mp-svg-icons-clear \
  --pkg-dir ./node_modules/@mp-svg-icons/douyin/tdesign \
