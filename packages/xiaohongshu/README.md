...
{
  "usingComponents": {
    "add-icon": "@mp-svg-icons/xiaohongshu/tdesign/add-icon",
    "close-icon": "@mp-svg-icons/xiaohongshu/tdesign/close-icon"
  }
}
```
...
npx mp-svg-icons-clear \
  --pkg-dir ./node_modules/@mp-svg-icons/xiaohongshu/tdesign \
